...
const caseStudyData = {
  "1": {
    ...
    heroImage: withBaseAsset('/field-app-hero.png'),
    problem: {
    ...
    sections: [
      {
        ...
        additionalContentImageSrc: withBaseAsset('/field-app-old-screens.png'),
      ...
      },
      {
        ...
        hasImage: true,
        image: withBaseAsset('/field-app-early-prototype.png'),
      ...
      },
      {
        ...
        hasImage: true,
        image: withBaseAsset('/field-app-ia-diagram.png'),
      ...
      },
      {
        ...
        hasImage: true,
        image: withBaseAsset('/field-app-dark-mode.gif'),
      ...
      },
      {
        ...
        imageBeforeAdditionalContentSrc: withBaseAsset('/field-app-performance-dashboard.png'),
      ...
      },
      {
        ...
        hasImage: true,
        image: withBaseAsset('/field-app-dark-mode-screens.png'),
      },
    ],
  },
  "2": {
    ...
    heroImage: withBaseAsset('/ota-hero.png'),
    ...
    sections: [
      ...
      },
      {
        ...
        hasImage: true,
        image: withBaseAsset('/ota-old-screens.png'),
        ...
        hasImage2: true,
        image2: withBaseAsset('/ota-old-flow.gif'),
      ...
      },
      {
        ...
        hasImage: true,
        image: withBaseAsset('/en-route.gif'),
      },
      {
        ...
        hasImage: true,
        imagesSideBySide: [withBaseAsset('/ota-ab-test-a.png'), withBaseAsset('/ota-ab-test-b.png')],
     ...
     
      {
        ...
        hasImage: true,
        image: withBaseAsset('/ota-new-screens.png'),
        imageAfterSubsections: true,
  ...
  "3": {
    ...
    heroImage: withBaseAsset('/smartpitch-hero.png'),
    ...
    sections: [
      ...
      },
      {
        ...
        hasImage: true,
        image: withBaseAsset('/smartpitch-personas.png'),
      },
      {
      ...
      },
      {
        ...
        hasImage: true,
        image: withBaseAsset('/smartpitch-screens.png'),
      },
      {
        eyebrow: "THE RESULTS",
  ...
  "6": {
    ...
    heroImage: withBaseAsset('/field-app-case-study-6-header.png'),
      ...
      <div className="px-8 md:px-16 lg:px-24 pt-6 pb-24">
        ...
        {(study.sections as Array<{
          ...
          >
            ...
            {section.quotes && <QuotesCarousel quotes={section.quotes} />}
